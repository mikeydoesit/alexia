const Scents = [
    {
        name: 'Breathe',
        color: 'linear-gradient(to right bottom, rgba(107, 80, 96, .3), rgba(134,134,100, 1))',
        logoURL: 'images/breathe.png',
        imageURLs: ['images/breathe1.jpeg','images/breathe2.png','images/breathe3.png','images/breathe4.png'],
    ...
    {
        name: 'His Cologne',
        color: 'linear-gradient(to right bottom, rgba(255, 255, 151, .3), rgba(141,124,194, 1))',
        logoURL: 'images/hisCologne.png',
        imageURLs: ['images/hisCologne1.jpeg','images/hisCologne2.png','images/hisCologne3.png','images/hisCologne4.png','images/hisCologne5.png','images/hisCologne6.png'],
    ...
    {
        name: 'Fresh Laundry',
        color: 'linear-gradient(to right bottom, rgba(61, 134, 134, .3), rgba(224,102,104, 1))',
        logoURL: 'images/freshLaundry.png',
        imageURLs: ['images/freshLaundry1.jpeg','images/freshLaundry2.png','images/freshLaundry3.png','images/freshLaundry4.png','images/freshLaundry5.png','images/freshLaundry5.png'],
    ...
    },
    {
        ...
        color: 'linear-gradient(to right bottom, rgba(75, 80, 102, .3), rgba(150,128,105, 1))',
        logoURL: 'images/cocoaButterBaby.png',
        imageURLs: ['images/cocoaButterBaby1.jpeg','images/cocoaButterBaby2.png','images/cocoaButterBaby3.png','images/cocoaButterBaby4.png','images/cocoaButterBaby5.png','images/cocoaButterBaby6.png'],
    ...
    {
        name: 'Cosy Home',
        color: 'linear-gradient(to right bottom, rgba(255, 255, 255, .3), rgba(70,128,130, 1))',
        logoURL: 'images/cosyHome.png',
        imageURLs: ['images/cosyHome1.jpeg','images/cosyHome2.png','images/cosyHome3.png','images/cosyHome4.png','images/cosyHome5.png'],
    ...
    {
        name: 'Date Night',
        color: 'linear-gradient(to right bottom, rgba(255, 255, 255, .3), rgba(65,47,107, 1))',
        logoURL: 'images/dateNight.png',
        imageURLs: ['images/dateNight1.jpeg','images/dreams1.png','images/dreams2.png','images/dreams3.png'],
    ...
    {
        name: 'Dove',
        color: 'linear-gradient(to right bottom, rgba(255, 255, 255, .3), rgba(238,238,238, 1))',
    ...
    {
        name: 'Dreams',
        color: 'linear-gradient(to right bottom, rgba(255, 255, 255, .3), rgba(153,153,153, 1))',
    ...
    {
        name: 'Energy Cleanse',
        color: 'linear-gradient(to right bottom, rgba(255, 255, 255, .3), rgba(62,133,199, 1))',
    ...
    {
        name: 'Mango Love',
        color: 'linear-gradient(to right bottom, rgba(255, 255, 255, .3), rgba(246,178,107, 1))',
    ...
    {
        name: 'Passion Fruit',
        color: 'linear-gradient(to right bottom, rgba(255, 255, 255, .3), rgba(151,17,16, 1))',
    ...
    },
    {
        ...
        color: 'linear-gradient(to right bottom, rgba(255, 255, 255, .3), rgba(218,210,233, 1))',
    ...
    {
        name: 'Sweet Nectar',
        color: 'linear-gradient(to right bottom, rgba(255, 255, 255, .3), rgba(227,121,144, 1))',
    ...
    {
        name: 'White Sands',
        color: 'linear-gradient(to right bottom, rgba(255, 255, 255, .3), rgba(241,195,50, 1))',
    ...
    {
        name: 'Bora Bora',
        color: 'linear-gradient(to bottom, rgba(255, 255, 255, .3), #eeb928, #f79d87)',
