const Scents = [
    {
        name: 'Breathe',
        color: 'linear-gradient(to right bottom, rgba(172, 172, 138, 1), rgba(134,134,100, 1))',
    ...
    {
        name: 'His Cologne',
        color: 'linear-gradient(to right bottom, rgba(255, 255, 255, .7), rgba(141,124,194, 1))',
    ...
    {
        name: 'Fresh Laundry',
        color: 'linear-gradient(to right bottom, rgba(255, 255, 255, .7), rgba(224,102,104, 1))',
    ...
    },
    {
        ...
        color: 'linear-gradient(to right bottom, rgba(255, 255, 255, .7), rgba(150,128,105, 1))',
    ...
    {
        name: 'Cosy Home',
        color: 'linear-gradient(to right bottom, rgba(255, 255, 255, .7), rgba(70,128,130, 1))',
    ...
    {
        name: 'Date Night',
        color: 'linear-gradient(to right bottom, rgba(255, 255, 255, .7), rgba(65,47,107, 1))',
    ...
    {
        name: 'Dove',
        color: 'linear-gradient(to right bottom, rgba(255, 255, 255, .7), rgba(238,238,238, 1))',
    ...
    {
        name: 'Dreams',
        color: 'linear-gradient(to right bottom, rgba(255, 255, 255, .7), rgba(153,153,153, 1))',
    ...
    {
        name: 'Energy Cleanse',
        color: 'linear-gradient(to right bottom, rgba(255, 255, 255, .7), rgba(62,133,199, 1))',
    ...
    {
        name: 'Mango Love',
        color: 'linear-gradient(to right bottom, rgba(255, 255, 255, .7), rgba(246,178,107, 1))',
    ...
    {
        name: 'Passion Fruit',
        color: 'linear-gradient(to right bottom, rgba(255, 255, 255, .7), rgba(151,17,16, 1))',
    ...
    },
    {
        ...
        color: 'linear-gradient(to right bottom, rgba(255, 255, 255, .7), rgba(218,210,233, 1))',
    ...
    {
        name: 'Sweet Nectar',
        color: 'linear-gradient(to right bottom, rgba(255, 255, 255, .7), rgba(227,121,144, 1))',
    ...
    {
        name: 'White Sands',
        color: 'linear-gradient(to right bottom, rgba(255, 255, 255, .7), rgba(241,195,50, 1))',
    ...
    {
        name: 'Bora Bora',
        color: 'linear-gradient(to right bottom, #eeb928, #f79d87)',
